...
export default function cli() {
	...
	program.command('update-plugins')
		...
		.addOption(new Option('--environment <env>', 'Which environment to use.').choices(['development', 'tests']).default('all'))
		.allowUnknownOption(true)
	...
	program.command('generate')
		.description('Generate posts/pages in the WordPress environment.')
		.addOption(new Option('-d, --directory <path>', 'Path to directory containing files to be used for generation.').default('.'))
		.addOption(new Option('-f, --file <file>', 'Files to be used for generation.'))
		.addOption(new Option('-t, --type <type>', 'Type of content to generate.').choices(['post', 'page']).default('page'))
		.addOption(new Option('--environment <env>', 'Which environment to use.').choices(['development', 'tests']).default('all'))
		.allowUnknownOption(true)
		.action( withSpinner(env.generatePosts) )
