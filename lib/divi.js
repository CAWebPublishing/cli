...
async function configureDivi( environment, config, spinner ) {
	...
	if( activeTheme ){
		...
		diviOptions = diviOptions ? JSON.parse( diviOptions.out ) : {};
		diviBuilderOptions = diviBuilderOptions ? JSON.parse( diviBuilderOptions.out ) : {};
		diviUpdateOptions = undefined !== diviUpdateOptions && diviUpdateOptions ? JSON.parse( diviBuilderOptions.out ) : {};
