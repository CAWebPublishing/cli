...
v1.18.1
- Updated npm packages
- Updated WordPress core to 7.1.1

v1.18.0
- Updated npm packages
- Updated WordPress core to 7.1
...
v1.17.4
- Updated WordPress core to 7.0.4
- Updated npm packages

v1.17.3
- Updated WordPress core to 7.0.2
- Updated npm packages
...
-- cleanup is missing
-- status is missing
- Updated Query Monitor version
- Updated CAWeb version

v1.16.12
- Updated WordPress version 
- Updated wp-env config that is autogenerated to match new wp-env configurations
- Updated npm packages
